...
void MX_GPIO_Init(void)
{
  ...
  /**/
  LL_GPIO_ResetOutputPin(GPIOF, LL_GPIO_PIN_2|LL_GPIO_PIN_3|LL_GPIO_PIN_4|LL_GPIO_PIN_14);

  /**/
  LL_GPIO_ResetOutputPin(GPIOE, LL_GPIO_PIN_14|LL_GPIO_PIN_15);

  /**/
  LL_GPIO_ResetOutputPin(GPIOD, LL_GPIO_PIN_8);

  /**/
  LL_GPIO_ResetOutputPin(GPIOG, LL_GPIO_PIN_7);

  /**/
  GPIO_InitStruct.Pin = LL_GPIO_PIN_2|LL_GPIO_PIN_3|LL_GPIO_PIN_4|LL_GPIO_PIN_14;
